...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "h-9 w-full bg-sidebar-accent shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring border-sidebar-border",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    ...
    >
      ...
      <ScrollBar
        className="w-3 bg-[hsl(var(--sidebar-scroll-bar))] [&>div]:w-1 [&>div]:bg-[hsl(var(--sidebar-scroll-bar-thumb))]"
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 mb-2 flex h-8 shrink-0 items-center px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
